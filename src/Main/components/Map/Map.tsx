...
export default function Map() {
    ...
    const paths: Path[] = [
        { id: "경주시내권", d: "M542.01,762.55l35.06,35.99,58.3-88.86,35.05-21.37-56.42-98.98-48.37-26.99-7.87-78.73-34.87-23.62-41.62,16.87-99.82-53.16c.92,3.69-15.64,4.69-37.07,4.47l-17.2,55.44,44.99,83.23-6.75,87.73,58.49,83.8,48.36,12.79,69.74,11.39Z", region: "경주시내권", pathName: "Gyeongju-sinae-kwon", className: "cls-6" },
        { id: "불국사권", d: "M797.33,848.12l-7.31-79.95,7.31-29.81-14.62-35.43-48.36-37.12h-31.49l-19.12,37.12-13.31-14.62-35.05,21.37-58.3,88.86,23.43,56.24,21.37,24.74-27.84,70.02v75.52c0,3.33,1.93,6.36,4.94,7.78l71.5,33.51c2.87,1.35,6.2,1.33,9.06-.04l127.08-61.1,7.59-132.44-16.87-24.65Z", region: "불국사권", pathName: "Bulguksa-kwon", className: "cls-2"  },
        { id: "남산권", d: "M600.49,854.78l-23.43-56.24-35.06-35.99-69.74-11.39-48.36-12.79-53.99,63.55-55.11-41.62-34.87-4.5v50.61l5.3,151.47,30.42-15.93,111.62-54.62c4.61-2.25,10.01-2.18,14.55.19l106.49,55.56c1.78.93,3.72,1.53,5.71,1.76l40,4.71,27.84-70.02-21.37-24.74Z", region: "남산권", className: "cls-5"  }, //pathName: "Namsan-kwon"
        { id: "서부권", d: "M279.93,755.8l34.87,4.5,55.11,41.62,53.99-63.55-58.49-83.8,6.24-81.11c.33-4.33-.59-8.65-2.65-12.47l-41.83-77.39,17.2-55.44c-25.48-.26-57.82-2.24-75.82-3.48-8.66-.59-17.11,2.82-22.94,9.25l-50.37,55.56c-5.59,6.16-8.68,14.18-8.68,22.5v55.96c0,6.29-1.5,12.49-4.36,18.09l-46.5,90.78c-1.52,2.97-2.77,6.07-3.73,9.26l-21.34,71.12-37.16,75.74c-1.62,3.3-1.59,7.18.07,10.46l51.82,102.05c2.16,4.25,5.86,7.52,10.35,9.13l58.58,21.03c2.99,1.07,5.07,3.8,5.32,6.97l5.76,73.08c.18,2.32,1.74,4.3,3.94,5.04l49.14,16.38c1.73.58,3.31-1.2,2.54-2.85l-18.91-40.53c-1.7-3.64-1.82-7.82-.34-11.55l18.65-47.09c1.35-3.4,3.87-6.2,7.11-7.9l17.71-9.28-5.3-151.47v-50.61Z", region: "서부권", className: "cls-2"  },// pathName: "Seobu-kwon"
        { id: "북부권", d: "M522.89,459.98l34.87,23.62,8.16-85.48,37.96,11.25,21.37,18,37.12-5.62,38.24,19.12h37.91l2.3-17.16-105.46-264.19c-.53-1.33-.51-2.83.06-4.15l12.81-29.66c.7-1.63-.49-3.44-2.26-3.44h-65.33c-2.11,0-3.98,1.38-4.61,3.4l-15.68,50.66c-.92,2.97-3.18,5.33-6.11,6.36l-110.12,38.96c-2.57.91-5.43-.16-6.77-2.54l-5.73-10.19-2.39-13.96c-.47-2.76-3.57-4.19-5.98-2.76l-19.68,11.65c-1.83,1.08-3.11,2.9-3.51,4.99l-8.14,42.11c-.52,2.69-1.86,5.16-3.84,7.06l-11.82,11.33c-1.78,1.71-4.43,2.16-6.68,1.13l-32.17-14.71c-1.54-.7-3.27.53-3.09,2.21,1.43,13.5,6.89,60.41,17.61,98.56,10.37,36.91,28.39,62.63,29.53,67.19l99.82,53.16,41.62-16.87Z", region: "북부권", className: "cls-5"  },// pathName: "Bukbu-kwon"
        { id: "보문권", d: "M702.85,665.82h31.49l48.36,37.12,39.37-25.87-19.12-44.99,20.33-36.25h-1.5l-35.14-12.91c-2.28-.84-3.63-3.2-3.2-5.59l9.67-32.44c.48-2.63-1.07-5.2-3.61-6.02l-54.34-38.36c-2.6-.83-4.22-3.4-3.86-6.1l7.19-53.54h-37.91l-38.24-19.12-37.12,5.62-21.37-18-37.96-11.25-8.16,85.48,7.87,78.73,48.37,26.99,56.42,98.98,13.31,14.62,19.12-37.12Z", region: "보문권", className: "cls-3"  },// pathName: "Bomun-kwon"
        { id: "동해권", d: "M1019.39,622.34h-52.49c-2.64,0-5.1-1.34-6.54-3.55l-37.72-58.18c-1.36-2.1-3.61-3.47-6.11-3.72l-20.71-2.03c-2.29-.23-4.39,1.3-4.89,3.56l-6.95,31.93c-.7,3.2-3.53,5.48-6.8,5.48h-53.91l-20.33,36.25,19.12,44.99-39.37,25.87,14.62,35.43-7.31,29.81,7.31,79.95,16.87,24.65-7.59,132.44,130.76,40.42c4.67,1.44,9.64-1.14,11.14-5.79l9.05-28.04c1.21-3.76,3.81-6.93,7.26-8.86l25.98-14.54c3.58-2,6.13-5.44,7-9.44l62.24-283.64c.55-2.52.18-5.16-1.05-7.43l-33.66-62.01c-1.18-2.17-3.46-3.53-5.93-3.53Z", region: "동해권", className: "cls-6"  }, // pathName: "Donghae-kwon"
    ];
    ...
    const handlePathClick = (pathName: string) => {
        ...
        paths.forEach((path, index) => {
            const x = Math.random() * 200 - 100; // 무작위 x 이동
            const y = Math.random() * 200 - 100; // 무작위 y 이동
    
            setTimeout(() => {
                // 각 경로 애니메이션 실행
                const pathElement = document.getElementById(path.id); // path.id를 사용
                if (pathElement) {
                    pathElement.style.transform = `translate(${x}px, ${y}px)`;
                    pathElement.style.opacity = '0'; // 투명도 설정
                }
            }, index * 100); // 경로별로 지연시간 설정
        });
    
        setTimeout(() => {
            navigate(`/main/${pathName}`); // 해당 경로로 페이지 전환
        }, paths.length * 100); // 모든 애니메이션이 끝난 후 페이지 전환
    };

    // const calculateCenter = (d: string) => {
    //     const match = d.match(/M\s*(-?\d+(\.\d+)?),\s*(-?\d+(\.\d+)?)/) as RegExpMatchArray;

    //     const x = parseFloat(match[1])*0.85;
    //     const y = parseFloat(match[3])*0.9;
    ...
    return (
        ...
        // 오브젝트 혹은 컴포넌트로 변환 하기 위해서는 웹팩과 같은 번들러 추가가 필요
            ...
            >
                ...
                {paths.map((path, index) => (
                    ...
                    >
                        <Styled.MapSVGPath
                            ...
                            d={path.d}
                        />
                        {/* <foreignObject x={calculateCenter(path.d).x} y={calculateCenter(path.d).y} width={200} height={100}>
                            <div>
                ...
                {/* <path       
                id="경주시내권"
                onClick={() => handlePathClick("Gyeongju-sinae-kwon")}
                className="cls-6"
                ...
                {/* <path
                id="불국사권"
                onClick={() => handlePathClick("Bulguksa-kwon")}
                className="cls-2"
                ...
                {/* <path
                id="남산권"
                onClick={() => handlePathClick("Namsan-kwon")}
                className="cls-5"
                ...
                {/* <path
                id="서부권"
                onClick={() => handlePathClick("Seobu-kwon")}
                className="cls-2"
                ...
                {/* <path
                id="보문권"
                onClick={() => handlePathClick("Bomun-kwon")}
                className="cls-3"
                d="M702.85,665.82h31.49l48.36,37.12,39.37-25.87-19.12-44.99,20.33-36.25h-1.5l-35.14-12.91c-2.28-.84-3.63-3.2-3.2-5.59l9.67-32.44c.48-2.63-1.07-5.2-3.61-6.02l-54.34-38.36c-2.6-.83-4.22-3.4-3.86-6.1l7.19-53.54h-37.91l-38.24-19.12-37.12,5.62-21.37-18-37.96-11.25-8.16,85.48,7.87,78.73,48.37,26.99,56.42,98.98,13.31,14.62,19.12-37.12Z"
                /> */}
                <polygon
                ...
                {/* <path
                id="동해권"
                onClick={() => handlePathClick("Donghae-kwon")}
                className="cls-6"
